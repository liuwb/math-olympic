...
\begin{enumerate}
  ...
  \begin{center}
  \begin{tikzpicture}[
    titlebox/.style={draw=mainblue,rounded corners=2pt,minimum width=2.2cm,minimum height=0.68cm,fill=lightblue,font=\small\bfseries},
    listbox/.style={draw=black!50,rounded corners=2pt,minimum width=2.2cm,minimum height=2.25cm,fill=white,font=\small}
  ]
    \node[titlebox] (r0) at (0,0) {余 0};
    \node[titlebox] (r1) at (3.1,0) {余 1};
    \node[titlebox] (r2) at (6.2,0) {余 2};
    \node[listbox,align=center,below=0.12cm of r0] {3\\6\\9\\12};
    \node[listbox,align=center,below=0.12cm of r1] {1\\4\\7\\10};
    \node[listbox,align=center,below=0.12cm of r2] {2\\5\\8\\11};
  \end{tikzpicture}
  \end{center}
  \biganswerspace
  ...
  \begin{tikzpicture}[font=\small]
    \draw[fill=lightblue,draw=mainblue] (0,0) rectangle (1.2,2.1);
    \draw[fill=lightblue,draw=mainblue] (2.2,0) rectangle (3.4,2.1);
    \node at (0.6,2.45) {7};
    \node at (2.8,2.45) {7};
    \node at (1.7,1.05) {\Large $\longrightarrow$};
    \node[align=center] at (5.4,1.05) {每次总共\\取走 3 颗};
  \end{tikzpicture}
  \end{center}
  \answerspace
