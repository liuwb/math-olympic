...
\begin{enumerate}
  ...
  \begin{center}
  \begin{tikzpicture}[>=stealth,scale=0.86,font=\small]
    \draw[->,thick] (-0.5,0) -- (5.5,0);
    \foreach \x in {0,...,5} \draw (\x,0.1)--(\x,-0.1) node[below=2pt] {\x};
  ...
  \begin{tikzpicture}[scale=0.75]
    \foreach \x/\y in {0/0,1.5/0,3/0,4.5/0,6/0,0/-1.5,1.5/-1.5,3/-1.5,4.5/-1.5}
      \draw[mainblue,fill=white,line width=0.9pt] (\x,\y) circle (0.28);
    \node[draw=none,font=\small\color{rulegray}] at (3,-2.45) {每次只会改动两盏灯，亮灯数奇偶性保持不变。};
  \end{tikzpicture}
  \end{center}
  \answerspace
  ...
  \begin{tikzpicture}[scale=0.56]
    ...
    \fill[red!70!black] (4,4) circle (2.4pt);
