...
\begin{enumerate}
  ...
  \begin{tikzpicture}[scale=0.62]
    \draw[step=1cm,gray!55,thin] (0,0) grid (4,3);
    \fill[mainblue] (0,0) circle (2pt);
    \fill[mainblue] (4,3) circle (2pt);
    \fill[red!75!black] (2,2) circle (2.5pt);
    \draw[red!75!black,line width=0.9pt] (2,2) circle (0.18);
    \node[below left] at (0,0) {\small $(0,0)$};
    \node[above right] at (4,3) {\small $(4,3)$};
    \node[above] at (2,2) {\small 禁点 $(2,2)$};
  \end{tikzpicture}
  \end{center}
  \biganswerspace
...
\begin{enumerate}
  ...
  \begin{tikzpicture}[
    ...
    \begin{scope}
      \node[draw=none,fill=none,circle=false,font=\small\bfseries\color{mainblue}] at (1.6,2.2) {出现红边时};
      \node (A1) at (1.5,0.9) {$A$};
      \node (B1) at (0,0) {$B$};
      \node (C1) at (3,0) {$C$};
      \node (D1) at (1.5,-1.3) {$D$};
      ...
      \draw[rededge] (A1)--(D1);
      \draw[rededge] (B1)--(C1);
      \node[draw=none,fill=none,circle=false,font=\small\color{rulegray}] at (1.5,-2.0) {$A,B,C$ 为红三角形};
    \end{scope}
    \begin{scope}[xshift=7.4cm]
      \node[draw=none,fill=none,circle=false,font=\small\bfseries\color{mainblue}] at (1.6,2.2) {都不是红边时};
      \node (A2) at (1.5,0.9) {$A$};
      \node (B2) at (0,0) {$B$};
      \node (C2) at (3,0) {$C$};
      \node (D2) at (1.5,-1.3) {$D$};
      ...
      \draw[blueedge] (C2)--(D2);
      \draw[blueedge] (B2)--(D2);
      \node[draw=none,fill=none,circle=false,font=\small\color{rulegray}] at (1.5,-2.0) {$B,C,D$ 为蓝三角形};
    \end{scope}
  \end{tikzpicture}
  \end{center}
  \end{solution}
