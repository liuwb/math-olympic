...
\begin{tikzpicture}[scale=0.5]
  \node[draw=none,fill=none,font=\bfseries\color{mainblue}] at (8.2,9.4) {附图参考};
  \foreach \x in {0,...,7} {
    \foreach \y in {0,...,7} {
  ...
  \draw[accent,line width=1.1pt] (7,7) rectangle ++(1,1);
  \draw[accent,line width=1.0pt] (0,7)--(1,8) (1,7)--(0,8) (7,7)--(8,8) (8,7)--(7,8);

  \begin{scope}[xshift=10.5cm,scale=1.1]
    ...
    \fill[accent!18] (1,1) rectangle ++(3,1);
    \draw[accent,line width=1.1pt] (1,1) rectangle ++(3,1);
  \end{scope}
\end{tikzpicture}
\end{center}
